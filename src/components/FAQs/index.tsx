        ...
        <section className='lp-faqs'>
            <div className='lp-container'>
                ...
                <div className='lp-faq'>
                    <h3>O que é o serviço de mídia paga?</h3>
                ...
                <div className='lp-faq'>
                    ...
                    <p>Nossos serviços de construção e migração de e-commerce incluem o design, desenvolvimento e implementação de lojas online, bem como a migração de dados e conteúdos de plataformas existentes para novas soluções de e-commerce.</p>
                </div>
                <div className='lp-faq'>
